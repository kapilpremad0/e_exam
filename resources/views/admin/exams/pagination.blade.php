<table class="table mb-0">
    ...
    <tbody>
        @php  $i = ($services->currentPage() - 1) * $services->perPage() + 1; @endphp
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="fw-bolder"><a
                                    href="{{ route('admin.services.show', $item->id) }}">{{ $item->name ?? '' }}</a>
                            </div>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            {{-- <a class="dropdown-item" href="{{route('admin.services.show',$item->id)}}">
...
@include('admin._pagination', ['data' => $services])
{{-- @include('admin._pagination', ['data' => $services]) --}}
