                                    ...
                                    <div class="row">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="form-check form-check-primary form-switch">
                                                        <input type="checkbox" name="status" 
                                                            @if (!empty($plan))
                                                                {{ (isset($plan->status) && $plan->status == 1) ? 'checked' : '' }}
                                                            @else
                                                                checked
                                                            @endif
                                        ...
                                        {{-- <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                @if (!empty($plan->image))
                                                    <div>
                                                        <img src="{{ url('public/uploads/' . $plan->image) }}" alt=""
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="amount-column">Amount <span
                                                        class="error"></span></label>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select name="type" id="type" class="form-select select2" >
                                                    ...
                                                    @foreach ($types as $key => $val)
                                                        <option value="{{ $key }}"
                                                            {{ (isset($plan->type) && $plan->type == $key) ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="duration-column">Duration <span
                                                        class="error"></span></label>
                                                <select name="duration" id="duration" class="form-select select2" >
                                                    <option value="">(Select Duration)</option>
                                                    @foreach ($durations as $key => $val)
                                                        <option value="{{ $key }}"
                                                            {{ (isset($plan->duration) && $plan->duration == $key) ? 'selected' : '' }}
                                                        >{{ $val }}</option>
                                                    @endforeach
                                                </select>
