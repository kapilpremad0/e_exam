        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                ...
                {{-- <div class="col-md-3" style="text-align: end">
                    <a href="{{ route('admin.plans.create') }}" class=" btn btn-primary btn-gradient round  ">Create</a>
                </div> --}}
            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-company-table">
                            ...
                            <div class="table-responsive" id="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <div class="fw-bolder"><a href="{{ route('admin.plans.edit',$item->id) }}">{{ $item->name ?? '' }}</a></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('admin.plans.edit',$item->id)}}">
                                                                <i data-feather="edit-2" class="me-50"></i>
                                                                <span>Edit</span>
                                                            </a>
                                                            
                                                            {{-- <a class="dropdown-item" href="{{route('admin.plans.show',$item->id)}}">
                                                    ...
                                                    <div class="modal fade modal-danger text-start" id="danger_ke{{ $item->id }}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{route('admin.plans.destroy',$item->id)}}" method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                ...
                                {{-- @include('admin._pagination', ['data' => $plans]) --}}
                            </div>
