                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (!empty($subject->id))
                                        <form class="form" action="{{ route('admin.subjects.update', $subject->id) }}"
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="form-check form-check-primary form-switch">
                                                        <input type="checkbox" name="trending" 
                                                            @if (!empty($subject))
                                                                {{ (isset($subject->trending) && $subject->trending == 1) ? 'checked' : '' }}
                                                            @else
                                                                checked
                                                            @endif
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="type-column">Exam <span
                                                        class="error"></span></label>
                                                <select name="exam_id" id="exam_id" class="form-select select2" >
                                                    <option value="">(Select Type)</option>
                                                    @foreach ($exams as $key => $val)
                                                        <option value="{{ $val->id }}"
                                                            {{ (isset($subject->exam_id) && $subject->exam_id == $val->id) ? 'selected' : '' }}
                                                        
                                                        >{{ $val->name }}</option>
                                                    @endforeach
                                                </select>
                                                <span class="text-danger validation-class" id="exam_id-submit_errors"></span>
                                            </div>
                                        </div>
