        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                ...
                <div class="col-md-3" style="text-align: end">
                    <a href="{{ route('admin.subjects.create') }}" class=" btn btn-primary btn-gradient round  ">Create</a>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card card-company-table">
                                ...
                                <div class="table-responsive" id="table-responsive">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <div class="fw-bolder"><a
                                                                        href="{{ route('admin.subjects.edit', $item->id) }}">{{ $item->name ?? '' }}</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                    ...
                                    @include('admin._pagination', ['data' => $subjects])
                                </div>
                                ...
                                {{ $subjects->links('admin._pagination') }}
                            </div> --}}
                            </div>
                        </div>
                    </div>
