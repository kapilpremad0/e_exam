            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Support</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{  route('admin.dashboard') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.supports.index') }}">Supports</a>
                                    </li>
                ...
                @can('supports create')
                    <div class="col-md-3" style="text-align: end">
                        <a href="{{ route('admin.supports.create') }}" class=" btn btn-primary btn-gradient round  ">Create</a>
                    </div>
                @endcan
            </div>
